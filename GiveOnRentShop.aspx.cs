...
public partial class GiveOnRent : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string s;
        s = "Insert into ShopMaster values('" + TextBox1.Text + "','" + DropDownList4.Text + "','" + TextBox2.Text + "','" + DropDownList1.Text + "'," + TextBox3.Text + "," + TextBox4.Text + ",'" + TextBox5.Text + "','Rent','Available')";

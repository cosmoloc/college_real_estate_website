...
public partial class TakeOnLease : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        cn.Open();
        string s = "select * from HouseMaster Where AreaSFT >= " + TextBox1.Text + " AND City='" + DropDownList1.Text + "' AND Purpose='Lease'";

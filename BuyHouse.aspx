<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuyHouse.aspx.cs" Inherits="Buy" %>
        ...
        <div class="admin_login">
            ...
            <asp:Panel ID="Panel1" runat="server" BackColor="#F2EFEF" Font-Bold="True" 
                ...
                <asp:Label ID="Label2" runat="server" BorderStyle="None" Font-Bold="True" 
                    ...
                    Font-Underline="True" 
                    style="top: 164px; left: 80px; position: absolute; height: 29px; width: 202px" 
                    Text="Buy House"></asp:Label>
            </asp:Panel>

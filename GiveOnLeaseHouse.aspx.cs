...
public partial class GiveOnLease : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string s;
        s = "Insert into HouseMaster values('" + TextBox1.Text + "','" + DropDownList4.Text + "','" + TextBox2.Text + "','" + DropDownList1.Text + "'," + TextBox3.Text + ",'" + DropDownList2.Text + "','" + DropDownList3.Text + "'," + TextBox4.Text + ",'" + TextBox5.Text + "','Lease','Available')";
